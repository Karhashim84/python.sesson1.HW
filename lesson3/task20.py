...
N = abs(int(input('Введите язык ввода, 1 - английский, 2 - русский: ')))
word = input('Введите слово: ').upper()
if N == 1:
	print('В этом слове -> ', sum([k for i in word for k, v in eng.items() if i in v]), 'очков')
elif N == 2:
	print('В этом слове ->', sum([k for i in word for k, v in rus.items() if i in v]), 'очков')
else:
    print('Что то не так!')